(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('@angular/core'), require('@zxing/library'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@zxing/ngx-scanner', ['exports', '@angular/common', '@angular/forms', '@angular/core', '@zxing/library', 'rxjs'], factory) :
    (factory((global.zxing = global.zxing || {}, global.zxing['ngx-scanner'] = {}),global.ng.common,global.ng.forms,global.ng.core,global.library,global.rxjs));
}(this, (function (exports,common,forms,core,library,rxjs) { 'use strict';
